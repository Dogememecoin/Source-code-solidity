...
contract DOGEMEME is ERC20, Ownable {
    ...
    constructor () ERC20("Dogememecoin", "DOGEMEME") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingWallet = 0xd150eC6b70Fa00C1B1B82F5b246a778F95C0cadA;
        developerWallet = 0xAAd20D487B316e02137E9b8C12D20673c8f63BF8;
